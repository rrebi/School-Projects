...
namespace Chicken_Invaders_Abrudan_Rebeca
{
    public partial class Lv2 : Form
    {
        ...
        Bitmap _puiI = Properties.Resources.puiR;
        List<Bitmap> _puiF = new List<Bitmap>();
        Poza[,] _pui = new Poza[3, 8];
        int[] puiT = new int[3];
        ...
        private void initial()
        {
            ...
            _nava.Left = 900 / 2 - _nava.Width / 2;
            _nava.Top = 500 - _nava.Height;
            _nava.Tag = "nava";
